...
const Publications = () => {
  ...
  const removePublication = async (id) => {
    ...
    try {
      ...
      Swal.fire(t("delete.title"), t("delete.publication_success"), "success")
    } catch (error) {
      console.error("Error deleting publication:", error)
      Swal.fire(t("error"), t("delete.publication_error"), "error")
    }
  }
                ...
                <Col key={product.id} xs={12} sm={6} md={4} lg={3}>
                  ...
                  >
                    <Card.Body className="px-0 pb-0 pt-1">
                      ...
                      <div>
                        <strong>{t("price")}:</strong> ${product.price.toLocaleString()}
                      </div>
