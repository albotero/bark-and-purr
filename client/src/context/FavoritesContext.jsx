...
export function FavoritesProvider({ children }) {
  ...
  }, [fetchData, isAuthenticated, getToken])
  ...
  const toggleFavorite = useCallback(
    ...
    [fetchData, favorites, isDeleting, getToken]
  )
  ...
  const removeFromFavorites = useCallback(
    async (favoriteId, e) => {
      ...
      if (isDeleting) {
        console.log("Ya hay una eliminación en curso, ignorando llamada repetida.")
        return
      }
      ...
      try {
        ...
        if (!response.error) {
          setFavorites((prev) => prev.filter((item) => getFavoriteId(item) !== idNum))
