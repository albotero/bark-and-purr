...
CREATE TABLE users (
  ...
  address_line_1 VARCHAR(50) DEFAULT 'Sin información',
  address_line_2 VARCHAR(50) DEFAULT 'Sin información',
  city VARCHAR(50) DEFAULT 'Sin información',
  state VARCHAR(50) DEFAULT 'Sin información',
  country VARCHAR(50) DEFAULT 'Sin información',
